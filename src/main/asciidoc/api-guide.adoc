...
| votes | List<Vote> | List of user votes of that restaurant
|====
...
|====
| *Name* | *Type* | *Optional* | *Description*
| restaurantId | Integer | true | The value indicating whenever to fetch or not the related list of votes, `false` by default
|====
